      ...
      <span class="text-uppercase font-weight-bold">Company</span> -->
        ...
        <div id="navbarSupportedContent" class="collapse navbar-collapse">
          <ul class="navbar-nav z-navbar-nav ml-auto text-uppercase">
            ...
            <li class="nav-item z-nav-item">
              <a href="services.php" class="nav-link scroll-link">Services</a>
            </li>
            <!-- <li class="nav-item z-nav-item">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form class="shake" action="https://formsubmit.co/jpgabad52@gmail.com" role="form" method="post" id="contactForm" name="contact-form" data-toggle="validator">
              <!-- Company Name -->
